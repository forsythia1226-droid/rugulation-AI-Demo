 ...
 * - 구조(업무구분/업무내용, 공통 결재권자, 안전보건경영, 유관조직 합의·참조, ●결정 ◎보고)는 실제 기준표 양식을 따른다.
 * - 내용은 가상 데이터다. 데모 조문(위임전결규정 제7·8조, 직제규정 제12조 등)과 맞물리게 작성했다.
 *   실제 기준표는 공개 저장소에 넣지 않는다. 운영 시 원본(엑셀)을 서버에서 불러와 같은 화면으로 보여준다.
 * - 행: [깊이, 업무내용, 팀장, 부문장, 대표이사, EHS팀장, 안전총괄대표, 합의, 참조, 근거조문ID, 비고]
 */
const ANNEX_105={
 title:"위임전결기준표",sub:"국내/본사 기준 · 〈별표 제1호〉",
 cols:[["t","팀장"],["d","부문장"],["c","대표이사"]],safety:[["e","EHS팀장"],["s","안전총괄대표"]],
 rows:[
 [0,"1. 경영관리"],
 [1,"1) 경영전략"],
 [2,"(1) 중장기 비전 및 전략","","","●","","","","경영기획팀"],
 [2,"(2) 신규사업·M&A 검토","","","●","","","재무팀, 법무팀","경영기획팀"],
 [1,"2) 사업계획"],
 [2,"(1) 전사 사업계획","","","●","","","재무팀","경영기획팀"],
 [2,"(2) 부문 사업계획","","●","◎","","","","경영기획팀"],
 [2,"(3) 팀 실행계획","●","◎"],
 [1,"3) 실적 보고(월/분기)"],
 [2,"(1) 부문","","●","◎"],
 ...
 [2,"③ 2,000만원 초과","","","●","","","재무팀","","105-7"],
 [1,"2) 국내출장비"],
 [2,"① 200만원 이하","●","","","","","","","105-7"],
 [2,"② 200만원 초과 1,000만원 이하","","●","","","","","","105-7"],
 [2,"③ 1,000만원 초과","","","●","","","재무팀","","105-7"],
 [1,"3) 해외출장비"],
 [2,"① 500만원 이하","","●","","","","","","105-7","팀장 전결 불가"],
 [2,"② 500만원 초과","","","●","","","재무팀","","105-7"],
 [1,"4) 접대비"],
 [2,"① 100만원 이하","●","","","","","","","105-7"],
 ...
 [2,"② 500만원 초과 5,000만원 이하","","●","","","","재무팀","구매팀","105-7"],
 [2,"③ 5,000만원 초과","","","●","","","재무팀","구매팀","105-7"],
 [1,"6) 원부자재 구매"],
 [2,"① 1,000만원 이하","●","","","","","","구매팀","105-7"],
 [2,"② 1,000만원 초과 2억원 이하","","●","","","","","구매팀","105-7"],
 [2,"③ 2억원 초과","","","●","","","재무팀","구매팀","105-7"],
 [1,"7) 외주용역 계약"],
 [2,"① 1,000만원 이하","●","","","","","","","105-7"],
 [2,"② 1,000만원 초과 1억원 이하","","●","","","","법무팀","","105-7"],
 [2,"③ 1억원 초과","","","●","","","법무팀, 재무팀","","105-7"],
 [1,"8) 교육·행사비"],
 ...
 [1,"3) 안전보건 예산 편성","","","◎","","●","재무팀","","111-12"],
 [1,"4) 작업중지 명령","","","◎","","●","","","111-12","급박한 위험 시 즉시 명령 후 보고"],
 [1,"5) 중대재해 대응 및 재발방지 대책","","","◎","","●","","경영기획팀","111-12"],
 [0,"5. 대외·정보보안"],
...
function annexHTML(k){
 ...
 return `<div class="annex">
  ...
  <div class="ax-wrap"><table class="ax">
   <thead><tr><th rowspan="2" class="ax-item">업무내용</th><th colspan="${A.cols.length}">공 통</th><th colspan="${A.safety.length}">안전보건경영</th><th colspan="2">유관조직</th></tr>
