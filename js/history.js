...
const HISTORY=[
 ...
 {id:"h111-3",key:"TES-111",date:"2026.07.15",eff:"2026.08.01",type:"개정",reason:"중대재해처벌법 대응: 안전총괄대표 신설 및 업무 범위 규정",changes:[
  ...
  {art:"111-B1",table:true,before:["경영기획팀","경영계획 수립, 조직·직제 관리, 위임전결 운영","TES-105, TES-108, TES-111, TES-216, TES-301, TES-801"],after:["경영기획팀","경영계획 수립, 조직·직제 관리, 위임전결 운영, 중대재해처벌법 리스크 점검 지원","TES-105, TES-108, TES-111, TES-216, TES-301, TES-801"]}]},
 {id:"h105-1",key:"TES-105",date:"2014.07.01",eff:"2014.07.01",type:"제정",reason:"위임전결규정 제정",changes:[]},
 {id:"h105-2",key:"TES-105",date:"2025.12.15",eff:"2026.01.01",type:"개정",reason:"출장비 전결 한도 현실화 및 분할 기안 방지 강화",changes:[
 ...
 {id:"h201-1",key:"TES-201",date:"2013.01.01",eff:"2013.01.01",type:"제정",reason:"인사규정 제정",changes:[]},
 {id:"h201-2",key:"TES-201",date:"2025.12.15",eff:"2026.01.01",type:"개정",reason:"경력직 채용 확대에 따른 수습기간 단축 및 경력 인정 기준 보완",changes:[
  {art:"201-8",before:"② 경력채용자의 수습기간은 신규 채용된 자와 동일하게 3개월로 한다.",after:"② 경력채용자의 수습기간은 2개월로 하되, 동종업계 경력 5년 이상인 자는 대표이사 승인으로 수습기간을 면제할 수 있다."},
  {art:"201-10",before:"④ 이종업계 경력: 50퍼센트 인정한다.",after:"④ 이종업계 경력: 50퍼센트 인정하되, 인사위원회가 직무 관련성을 인정하는 경우 80퍼센트까지 인정할 수 있다."},
  {art:"201-10",before:null,after:"⑦ 경력 인정에 대한 이의는 임용일부터 3개월 이내에 인사팀에 제기할 수 있다."}]},
