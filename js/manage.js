...
const STAFF={
 ...
 "IT혁신팀":["강태윤 과장","오세린 대리","임도현 차장"],"총무팀":["서지우 과장","배준영 대리"],
 "감사팀":["문가영 차장","송재원 대리"],"윤리경영팀":["조은비 과장","권태민 대리"],"법무팀":["홍예린 과장","남궁현 대리"],
 "재무팀":["유승호 과장","신아름 대리"],"재무기획팀":["전민석 과장","황보라 대리"],"내부회계관리팀":["노지환 과장","구하은 대리"],
 "컴플라이언스팀":["백서준 과장","양소희 대리"],"연구개발팀":["안재현 책임","류시아 선임"],"품질보증팀":["손우진 과장","차유나 대리"],
 "구매팀":["표성민 과장","엄지수 대리"]};
